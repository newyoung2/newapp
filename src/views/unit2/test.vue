  ...
  methods: {
    init() {
      ...
      new MTLLoader(that.manager)
        .setPath(
          `${window.location.protocol}//${window.location.host}/models/male02/`
        )
      ...
      that.renderer.setSize(window.clientWidth, window.clientHeight);
    ...
    onDocumentMouseDown(event) {
      ...
      if (intersects.length > 0) {
        ...
        intersects[0].object.material.color = "#ffffff";
      }
    },
    getIntersects(x, y) {
      ...
      return this.raycaster.intersectObject(this.knot.children, true);
    },
    onWindowResize() {
